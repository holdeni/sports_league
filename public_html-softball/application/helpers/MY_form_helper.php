<?php
// $Id: MY_form_helper.php 230 2012-04-10 00:54:23Z Henry $
// Last Change: $Date: 2012-04-09 20:54:23 -0400 (Mon, 09 Apr 2012) $
...
/* ... if this is a text area, handle it */
			elseif ($formFields[$i]['type'] == "textarea") {
?>
			<td><?= form_textarea( $data[$formFields[$i]['fieldName']] ) ?></td>
