...
// $Id: sched_tournament.php 260 2012-08-16 16:09:44Z Henry $
// Last Change: $Date: 2012-08-16 12:09:44 -0400 (Thu, 16 Aug 2012) $
...
/* ... if the game was played, we need to place the winner and maybe the loser in their next game */
         ...
         if ($gamePlayed  &&  $formData['VisitScore'] != $formData['HomeScore']) {
            ...
            if ($this->config->item( 'my_playoffs' ) == "DOUBLE_ELIM") {
...
/* ... include some information about next games */
			if ($this->config->item( "my_playoffs" ) == "DOUBLE_E") {
...
/* ... put in the standard details about disagreements */
      ...
      $body .= "If there is agreement to change the score, you must contact ".$this->config->item( 'my_replyAddress' )." with details of the change. ";
