...
// $Id: mainpage.php 256 2012-08-02 18:44:12Z Henry $
// Last Change: $Date: 2012-08-02 14:44:12 -0400 (Thu, 02 Aug 2012) $
...
/* ... email the new password to the account's email address */
            ...
            $bccAddr = array();
            $subject = "Password reset requested for ".$this->config->item( 'siteName' )." website";
...
<?php
         foreach ($games as $gameIndex) {
            if ($schedGames[$gameIndex]['Status'] == "PLAYED"  ||  $schedGames[$gameIndex]['Status'] == "FORFEIT-VISIT"  ||  $schedGames[$gameIndex]['Status'] == "FORFEIT-HOME") {
