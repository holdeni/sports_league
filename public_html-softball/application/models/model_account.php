<?php
// $Id: model_account.php 217 2012-03-26 22:42:40Z Henry $
// Last Change: $Date: 2012-03-26 18:42:40 -0400 (Mon, 26 Mar 2012) $
...
/* ... create the email to be sent */
      ...
      if ($newAcct) {
         $subject = "New account created at ".$this->config->item( 'siteName' )." website";
       }
      else {
         $subject = "Account updated at ".$this->config->item( 'siteName' )." website";
       }
       
      $body  = "This email has been sent by an automated process and does not require a reply.\n\n";
      
      if ($newAcct) {
         $body .= "A new account has been registered with this email address at the ".$this->config->item( "siteName" )." website ";
         $body .= "(".base_url()."). The new account details are: \n";
       }
      else {
         $body .= "Your account has recently been updated at the ".$this->config->item( "siteName" )." website ";
