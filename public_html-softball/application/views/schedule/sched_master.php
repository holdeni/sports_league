<?php
// $Id: sched_master.php 252 2012-08-01 15:16:59Z Henry $
...
<div id="schedule">
   ...
   <table border="border">
      ...
      <tr class="forfeit">
         <td>Games has been recorded as a forfeit by one team</td>
      </tr>
      <tr class="rainout">
...
?>
      <tr class="<?= $newGameDate  &&  $scheduleFormat['type'] != "team" ? "newDay" : "" ?>
                 ...
                 <?= $schedDetails[$i]['Status'] == "FORFEIT-VISIT"  ||  $schedDetails[$i]['Status'] == "FORFEIT-HOME" ? "forfeit" : "" ?>">
