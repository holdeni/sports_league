...
<div>
   ...
   <ul>
      <li><?= anchor( "schedule/sched_tournament/showGames", "View all games" ) ?></li>
      <br />
      <li><?= anchor( "schedule/sched_tournament/showGames/A", "Show Group A tournament" ) ?></li>
      <li><?= anchor( "schedule/sched_tournament/showGames/B", "Show Group B tournament" ) ?></li>
      <li><?= anchor( "schedule/sched_tournament/showGames/C", "Show Group C tournament" ) ?></li>
      <br />
