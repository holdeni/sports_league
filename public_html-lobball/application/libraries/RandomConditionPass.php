<?php
// $Id: RandomConditionPass.php 84 2011-04-13 19:22:44Z Henry $
...
class RandomConditionPass{
   
	var $PasswordLength;    // Variable To Assign Password Length
	var $caps = 'ABCDEFGHIJKLMNPQRSTUVWXYZ';
	...
	function initialize($passLen,$condition){ //Constructor To Assign Values
