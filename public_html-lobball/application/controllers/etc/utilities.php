<?php
// $Id: utilities.php 167 2011-06-09 15:18:07Z Henry $
// Last Change: $Date: 2011-06-09 11:18:07 -0400 (Thu, 09 Jun 2011) $
...
/* ... build the details of an email to be sent to each team involved in a game we found */
      $subjPrefix = "Lobball: Missing game results";
      ...
      $bodySuffix  = "\nPlease visit the league website (http://kanatalobball.org) and submit the result today. ";
      $bodySuffix .= "If you know you have submitted a result and have received this warning in error, please ";
      $bodySuffix .= "forward this email to webmaster@kanatalobball.org and we will investigate.\n";
...
/* ... build the details of an email to be sent, if we have any games that aren't rescheduled */
      if (count( $gameList ) > 0) {
         $toAddr = array( "the-exec@kanatalobball.org" );
         $subject = "Lobball: Rainout games that require rescheduling";
